...
function leerDatosPlatillo(platillo){
    const infoPlatillo = {
        ...
        precio: platillo.querySelector('.price span').textContent,
...
function insertarCarrito(platillo) {
    ...
    <td>
         <img src="${platillo.imagen}" width=100> 
           ...
           <div class="hijo">${platillo.titulo}</div>
           <div>${platillo.precio}</div>
         <td>
     <a  class="bx bxs-trash-alt borrar-platillo cart-remove" data-id="${platillo.id}"></a>
    </td>
    `;
